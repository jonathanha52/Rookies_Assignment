        ...
        http
            ...
            .and()
                .authorizeRequests()
                    .antMatchers("api/v1/")
                    .permitAll()
                    .antMatchers(HttpMethod.GET, "api/v1/products/**", "api/v1/category/**")
                    .permitAll()
                    .antMatchers(HttpMethod.POST, "api/v1/products/**", "api/v1/category/**")
                    .hasRole(RoleName.ADMIN.name())
                    .antMatchers(HttpMethod.DELETE, "api/v1/products/**", "api/v1/category/**")
                    .hasRole(RoleName.ADMIN.name())
                    .antMatchers(HttpMethod.PUT, "api/v1/products/**", "api/v1/category/**")
                    .hasRole(RoleName.ADMIN.name())
                .and()
            .formLogin()
